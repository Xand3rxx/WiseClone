					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex flex-grow-1 flex-stack">
							...
							<div class="d-flex align-items-center me-5">
								...
								<a href="{{ route('home') }}">
									<img alt="Logo" src="{{ asset('assets/media/logos/brand_logo.svg') }}" />(Clone)
								</a>
							</div>
							<!--end::Header Logo-->
							<!--begin::Topbar-->
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="d-flex flex-column">
														<div class="fw-bolder d-flex align-items-center fs-5">{{ !empty($user['name']) ? Str::title($user['name']) : 'Unavailable' }}
														</div>
														<a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ !empty($user['email']) ? $user['email'] : 'Unavailable' }}</a>
													</div>
													<!--end::Username-->
												</div>
											</div>
						...
						<div class="header-menu-container container-xxl d-flex flex-stack h-lg-75px w-100" id="kt_header_nav">
							...
							<div class="header-menu flex-column flex-lg-row" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
								...
								<div class="flex-shrink-0 p-4 p-lg-0 me-lg-2">
									<a href="{{ route('transaction.create') }}" class="btn btn-sm btn-light-primary fw-bolder w-100 w-lg-auto" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Perform a new transaction">New Transaction</a>
								</div>
								<!--end::Actions-->
                                @endif
							</div>
